...
extern long gpio_initialize(void);

extern long gpio_finalize(void);

extern long gpio_set_function(uint8_t pin,
			      GPIO_FUNCTION func);

extern long gpio_get_function(uint8_t pin,
			      GPIO_FUNCTION &func);

extern long gpio_write(uint8_t pin,
		       uint8_t value);

extern long gpio_read(uint8_t pin,
		      uint8_t &value);
