...
static void              *m_gpio_map = NULL;
static volatile uint32_t *m_gpio = NULL;
...
long gpio_set_function(uint8_t pin,
		       GPIO_FUNCTION func)
{
...
long gpio_get_function(uint8_t pin,
		       GPIO_FUNCTION &func)
{
  CHECK_PIN_ALLOWED(pin);
